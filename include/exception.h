...
/*
 * Function: RaiseException_
 * Usage: RaiseException_(&e, name, value);
 * ---------------------------------------
...
void RaiseException_(exception *e, string name, void *value);
...
#define raise(e) RaiseException_(&e, #e, NULL)
